...
import 'package:novel/pages/data/model/response/book_info_resp.dart';
import 'package:novel/pages/data/repository/repository.dart';
...
import 'package:novel/widget/static_rating_bar.dart';
...
class BookInfoPageState extends State<BookInfoPage>
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text(
                        _bookInfoResp.rating != null ? _bookInfoResp.rating.score.toStringAsFixed(1) : "7.0",
                        style: TextStyle(
                            color: MyColors.fractionColor, fontSize: 23),
                      ),
                    ),
                    Text("分", style: TextStyle(color: MyColors.white, fontSize: Dimens.textSizeL),
                    ),
                  ],
                ),
              ],
  ...
  Widget bodyView() {
    return Row(
      ...
      children: <Widget>[
        bodyChildView(_isAddBookshelf ? 'images/icon_details_bookshelf_add.png' : 'images/icon_details_bookshelf.png', _isAddBookshelf ? "已在书架" : "加入书架", 0),
      ...
      child: new GestureDetector(
        onTap: () {
          if (tap == 0) {
            if (!_isAddBookshelf) {
              ///标签
              var bean = BookshelfBean(_bookName, _bookInfoResp.cover, "0", "", this.widget._bookId, 0, 0, 0,14177365);
        ...
        /*    Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (content) =>
                      BookChaptersPage(this.widget._bookId)),
            );*/
          }
        },
        child: Container(
