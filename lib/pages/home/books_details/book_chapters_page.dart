...
class BookChaptersPage extends StatefulWidget {
  ...
  BookChaptersPage(this._bookId,this._bookName,this._image);
...
class BookChaptersPageState extends State<BookChaptersPage> {
  ...
  getListBeanDate() async{
    _listBean=this.date.data.data;
    print(_listBean[0].id);
        ...
        onTap: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) {
            return BookContentPage(
                'http://api.pingcc.cn/fictionContent/search/${_listBean[index].chapterId}',
                this.widget._bookId,
                this.widget._image,
                index,
                _isReversed,
                ...
                0,
              _listBean,
              int.parse(_listBean[0].chapterId)
            );
          }));
        },
        child: Padding(
