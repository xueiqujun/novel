...
class BookshelfBean {
  BookshelfBean(this.title, this.image, this.readProgress, this.bookUrl, this.bookId, this.offset, this.isReversed, this.chaptersIndex,this.bookStar);
  /// 书名
  String title;
  String image;
  String readProgress;
